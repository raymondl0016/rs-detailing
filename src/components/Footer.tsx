...
const socialLinks = [
  {
    label: 'Instagram',
    href: 'https://www.instagram.com/luxedrivedetailing888/',
    icon: (
  ...
  {
    label: 'Facebook',
    href: 'https://www.facebook.com/luxedrivedetailing',
    icon: (
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" aria-hidden className="h-5 w-5">
  ...
  {
    label: 'YouTube',
    href: 'https://www.youtube.com/@LuxeDriveDetailing-x1p',
    icon: (
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" aria-hidden className="h-5 w-5">
          ...
          <div className="mt-6 flex gap-3">
            {socialLinks.map(({ label, href, icon }) => (
              <a
                ...
                aria-label={label}
                className="inline-flex h-10 w-10 items-center justify-center rounded-full border border-white/15 text-muted transition-colors hover:border-accent/40 hover:text-accent"
              >
                {icon}
              </a>
            ))}
